...
public class PlaceholderManager {
    ...
    private final Map<String, Placeholder> gamePlaceholder;
    private final Map<String, Map<String, Placeholder>> teamPlaceholder;
    private final Map<String, Map<String, Placeholder>> playerPlaceholder;
