...
public class Config {
    ...
    public static String friendlybreak_message_warning;
    public static String friendlybreak_message_kick;
    public static String friendlybreak_message_broadcast;
    ...
    public static void loadConfig() {
        ...
        for (String w : config.getStringList("resourcelimit.limit.limit")) {
            String[] ary = w.split(",");
        ...
        friendlybreak_message_warning = config.getString("friendlybreak_kick.message.warning");
        friendlybreak_message_kick = config.getString("friendlybreak_kick.message.kick");
        friendlybreak_message_broadcast = config.getString("friendlybreak_kick.message.broadcast");
